<?php get_header();?>
	<section class="banner d-flex flex-wrap align-items-end" style="background-image: url(.<?php echo get_template_directory_uri();?>>/banner.jpg)">
		<div class="background rellax" data-rellax-speed="-5" data-rellax-percentage="0.5">
			<img src="<?php echo get_template_directory_uri();?>/images//banner.jpg" class="img-fluid" alt="">
		</div>
		<div class="container">
			<div class="row">
				<div class="col-12">
		...
		<div class="banner-call-action d-flex align-items-end">
			...
			<div class="cta" style="background-image: url(<?php echo get_template_directory_uri();?>/images//banner-call-action.jpg)">
				<div class="text">
	...
	<div id="primary" class="content-area">
				...
				<div class="popularSlider">
						...
						<article class="popularpost d-flex align-items-end">
							...
							<div class="media">
								<a href="blog-details.html">
									<img src="<?php echo get_template_directory_uri();?>/images//popular-post-1.jpg" class="img-fluid" alt="">
								</a>
							</div>
					...
					<div class="col-lg-4 col-sm-6">
						<article class="popularpost d-flex align-items-end">
							...
							<div class="media">
								<a href="blog-details.html">
									<img src="<?php echo get_template_directory_uri();?>/images//popular-post-2.jpg" class="img-fluid" alt="">
								</a>
							</div>
					...
					<div class="col-lg-4 col-sm-6">
						<article class="popularpost d-flex align-items-end">
							...
							<div class="media">
								<a href="blog-details.html">
									<img src="<?php echo get_template_directory_uri();?>/images//popular-post-3.jpg" class="img-fluid" alt="">
								</a>
							</div>
					...
					<div class="col-lg-4 col-sm-6">
						<article class="popularpost d-flex align-items-end">
							...
							<div class="media">
								<a href="blog-details.html">
									<img src="<?php echo get_template_directory_uri();?>/images//popular-post-4.jpg" class="img-fluid" alt="">
								</a>
							</div>
			...
			<div class="container">
				<div class="row minus align-items-center">
					<div class="col-lg-8 col-md-6">
						<div class="media">
							<img src="<?php echo get_template_directory_uri();?>/images//asset-management.svg" class="img-fluid" alt="">
						</div>
					</div>
		...
		<section class="home-icref-suite">
			<div class="container">
				<div class="row lr-10 align-items-center">
					...
					<div class="col-md-7">
						<div class="media">
							<img src="<?php echo get_template_directory_uri();?>/images//home-icref-suite.svg" alt="">
						</div>
					</div>
				</div>
			</div>
		...
		<section class="home-about">
			<div class="background">
				<img src="<?php echo get_template_directory_uri();?>/images//home-about.svg" class="img-fluid" alt="">
			</div>	
			<div class="container">
				<div class="row flex-md-row-reverse align-items-center">
					...
					<div class="col-md-8">
						<a href="https://www.youtube.com/watch?v=QUCFquGq3CE" class="popup-video" data-effect="mfp-move-from-top">
							<div class="media">
								<img src="<?php echo get_template_directory_uri();?>/images//home-about.jpg" class="img-fluid" alt="">
							</div>
				...
				<div class="row lr-10 minus">
					<div class="col-md-4 col-sm-6">
						<a href="#" class="story-item d-flex flex-column">
							<div class="media">
								<img src="<?php echo get_template_directory_uri();?>/images//Story-1.jpg" class="img-fluid" alt="">
							</div>
					...
					<div class="col-md-4 col-sm-6">
						<a href="#" class="story-item d-flex flex-column">
							<div class="media">
								<img src="<?php echo get_template_directory_uri();?>/images//story-2.jpg" class="img-fluid" alt="">
							</div>
					...
					<div class="col-md-4 col-sm-6">
						<a href="#" class="story-item d-flex flex-column">
							<div class="media">
								<img src="<?php echo get_template_directory_uri();?>/images//story-3.jpg" class="img-fluid" alt="">
							</div>
